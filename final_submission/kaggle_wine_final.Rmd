...
- 5 models were analyzed as candidates for optimal prediction of points.
...
- Many transforms (the 5 here, and not shown) were attempted in order to overcome these violations of the assumptions of multiple linear regression by least squares minimization.
